...
{
	if (is_dir('core/themes/'.$_COOKIE['theme']))
		if (is_file('core/themes/'.$_COOKIE['theme'].'/'.$_COOKIE['theme'].'_1024.css'))
			$theme = $_COOKIE['theme'];
}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="core/themes/'.$theme.'/'.$theme.'_1024.css" title="1024" />
		<link rel="stylesheet" type="text/css" href="core/themes/'.$theme.'/'.$theme.'_1280.css" title="1280" />
...
$output .= '
					...
					<td class="table_top_middle">
						<div id="link1"><a href="'.$link_header['link1'].'">'.$lang_header['link1'].'</a></div>
						<div id="link2"><a href="'.$link_header['link2'].'">'.$lang_header['link2'].'</a></div>
						<div id="link3"><a href="'.$link_header['link3'].'">'.$lang_header['link3'].'</a></div>
						<div id="realm">Realm .:'.get_realm_name($realm_id).':.</a></div>
