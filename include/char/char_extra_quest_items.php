...
//########################################################################################################################
function char_quest_items(&$sqlr, &$sqlc, &$sqlw)
{
...
require_once './include/char/char_multi_realm_security.php';
...
$output .= '
	<h1>'.$lang_char['char_quest_items'].'</h1>
	<br />';

require_once './include/char/char_extra_header.php';
...
require_once './include/char/char_ footer.php';
