...
$total_found = $sql->num_rows($result);
  ...
  $output .= "<table class=\"lined\">
   <tr>
   	...
   	<th width=\"15%\"><a href=\"instances.php?order_by=levelMin&amp;start=$start&amp;dir=$dir\">".($order_by=='level_min' ? "<img src=\"img/arr_".($dir ? "up" : "dw").".gif\" /> " : "")."{$lang_instances['level_min']}</a></th>
   	<th width=\"15%\"><a href=\"instances.php?order_by=levelMax&amp;start=$start&amp;dir=$dir\">".($order_by=='level_max' ? "<img src=\"img/arr_".($dir ? "up" : "dw").".gif\" /> " : "")."{$lang_instances['level_max']}</a></th>
