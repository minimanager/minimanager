...
function add_bbcode_editor(){
	...
	$output .= "</select>
			<img src=\"img/editor/bold.gif\" onclick=\"addbbcode('msg','b')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/italic.gif\" onclick=\"addbbcode('msg','i')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/underline.gif\" onclick=\"addbbcode('msg','u')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/justifyleft.gif\" onclick=\"addbbcode('msg','left')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/justifycenter.gif\" onclick=\"addbbcode('msg','center')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/justifyright.gif\" onclick=\"addbbcode('msg','right')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/image.gif\" onclick=\"add_img('msg')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/link.gif\" onclick=\"add_url('msg')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/mail.gif\" onclick=\"add_mail('msg')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/code.gif\" onclick=\"addbbcode('msg','code')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
			<img src=\"img/editor/quote.gif\" onclick=\"add_quote('msg')\" width=\"21\" height=\"20\" style=\"cursor:pointer;\" /> 
		</div>
		<div style=\"display:block;padding-top:5px;\">";
	for($i=0;$i<count($bbcode_emoticons);$i++){
		$output .= "<img src=\"img/emoticons/{$bbcode_emoticons[$i][1]}.gif\" onclick=\"addText('msg','{$bbcode_emoticons[$i][0]}')\" width=\"{$bbcode_emoticons[$i][2]}\" height=\"{$bbcode_emoticons[$i][3]}\" style=\"cursor:pointer;padding:1px;\" />";
	}
	$output .= "</div>";
}
