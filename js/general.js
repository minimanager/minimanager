function do_submit (form_name,backup){
	if (form_name == 'form1') {
		if (backup == '1') document.form1.backup_op.value = "1";
			else if(document.form1.backup_op) document.form1.backup_op.value = "0";
				document.form1.submit();
				}
		else if (form_name == 'form2') document.form2.submit();
...
function ANSWERBOX() {
  ...
  this.init = function() {
    if(DOM) this.obj = document.getElementById('AnswerBox');
    else if(IE) this.obj = document.all.AnswerBox;
  }
