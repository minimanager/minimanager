...
$output .= "
	...
	<img src=\"img/editor/bold.png\" onclick=\"addbbcode('msg','b')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/italic.png\" onclick=\"addbbcode('msg','i')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/underline.png\" onclick=\"addbbcode('msg','u')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/text_align_left.png\" onclick=\"addbbcode('msg','left')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/text_align_center.png\" onclick=\"addbbcode('msg','center')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/text_align_right.png\" onclick=\"addbbcode('msg','right')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/image.png\" onclick=\"add_img('msg')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/link.png\" onclick=\"add_url('msg')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/email.png\" onclick=\"add_mail('msg')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/code.png\" onclick=\"addbbcode('msg','code')\" style=\"cursor:pointer;\" alt=\"\" />
	<img src=\"img/editor/quote.png\" onclick=\"add_quote('msg')\" style=\"cursor:pointer;\" alt=\"\" />
</div>
