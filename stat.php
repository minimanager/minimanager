...
foreach ($race as $id){
 ...
 <table class=\"bargraph\">
  ...
  foreach ($race as $id){
    ...
    $output .= "<td><a href=\"stat.php?race={$id[0]}\" class=\"graph_link\">{$race[$id[0]][3]}%<img src=\"./themes/$theme/column.gif\" width=\"69\" height=\"$height\" alt=\"{$race[$id[0]][2]}\" /></a></td>";
    }
$output .= "</tr><tr>";
  foreach ($race as $id){
...
foreach ($class as $id){
 ...
 <table class=\"bargraph\">
  ...
  foreach ($class as $id){
    ...
    $output .= "<td><a href=\"stat.php?class={$id[0]}\" class=\"graph_link\">{$class[$id[0]][3]}%<img src=\"./themes/$theme/column.gif\" width=\"69\" height=\"$height\" alt=\"{$class[$id[0]][2]}\" /></a></td>";
    }
$output .= "</tr><tr>";
  foreach ($class as $id){
...
foreach ($level as $id){
 ...
 <table class=\"bargraph\">
  ...
  foreach ($level as $id){
    ...
    $output .= "<td><a href=\"stat.php?level={$id[1]}\" class=\"graph_link\">{$level[$id[0]][4]}%<img src=\"./themes/$theme/column.gif\" width=\"77\" height=\"$height\" alt=\"{$level[$id[0]][3]}\" /></a></td>";
    }
$output .= "</tr><tr>";
  foreach ($level as $id){
